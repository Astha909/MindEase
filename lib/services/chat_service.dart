...
late final encrypt.Encrypter _aes =
encrypt.Encrypter(
encrypt.AES(_key),
);
...
print(
"🔎 getOrCreateChat started for user: $userId",
);
...
print(
"📦 Query completed. Docs: ${query.docs.length}",
);
...
listenToMessages(String chatId) {
return _firestore
    .collection('chats')
    .doc(chatId)
    .collection('messages')
